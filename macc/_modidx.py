...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'macc.core': {'macc.core.foo': ('core.html#foo', 'macc/core.py')},
            'macc.datasets': { 'macc.datasets.DataLoaders': ('datasets.html#dataloaders', 'macc/datasets.py'),
                               ...
                               'macc.datasets.get_grid': ('datasets.html#get_grid', 'macc/datasets.py'),
                               'macc.datasets.inplace': ('datasets.html#inplace', 'macc/datasets.py'),
                               'macc.datasets.show_image': ('datasets.html#show_image', 'macc/datasets.py'),
                               'macc.datasets.show_images': ('datasets.html#show_images', 'macc/datasets.py'),
                               'macc.datasets.subplots': ('datasets.html#subplots', 'macc/datasets.py')},
            'macc.learn': { 'macc.learn.Callback': ('learner.html#callback', 'macc/learn.py'),
                            ...
                            'macc.learn.ProgressCB': ('learner.html#progresscb', 'macc/learn.py'),
                            'macc.learn.ProgressCB.__init__': ('learner.html#progresscb.__init__', 'macc/learn.py'),
                            'macc.learn.ProgressCB._log': ('learner.html#progresscb._log', 'macc/learn.py'),
                            'macc.learn.ProgressCB.after_batch': ('learner.html#progresscb.after_batch', 'macc/learn.py'),
                            'macc.learn.ProgressCB.before_epoch': ('learner.html#progresscb.before_epoch', 'macc/learn.py'),
                            'macc.learn.ProgressCB.before_fit': ('learner.html#progresscb.before_fit', 'macc/learn.py'),
